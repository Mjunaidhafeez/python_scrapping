...
from PageObjects.Insurance_page import InsuranceClass
from PageObjects.Demographic_page import Demographicsclass
...
def patientchartpage_test():
    ...
    for r in range(1,88):
        ...
        if rowsize==2:
            print('============================= ' + str(r) + ' =============================')
            print(patientid)
            ptc.clickpatienteditdemo()
            demo=Demographicsclass(driver)
            demo.patient_demographics()
            insurance=InsuranceClass(driver)
